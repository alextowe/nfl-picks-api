...
class PickAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'owner', 'pick_group', 'matchup', 'selection', 'is_correct')
    list_display_links = ('id', 'owner', 'pick_group', 'matchup', 'selection', 'is_correct')
    search_field = ('id', 'owner', 'pick_group', 'matchup', 'selection', 'is_correct')
    ordering = ('id',)
    list_per_page = 25
